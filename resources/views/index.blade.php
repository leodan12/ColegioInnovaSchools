    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" filter-color="#8ce1fd" id="navigation"   >
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="No te pierdas este gran Twitter" data-placement="bottom" href="https://twitter.com/InnovaSchoolsPE" target="_blank">
              <i class="fab fa-twitter"></i>
              <p class="d-lg-none d-xl-none">Twitter</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" rel="tooltip" title="Mira este Facebook" data-placement="bottom" href="https://web.facebook.com/innovaschools/?_rdc=1&_rdr" target="_blank">

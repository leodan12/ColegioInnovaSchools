...
<div class="container-fluid"> 
    ...
    <div class="row ">
        ...
        <div class="col-sm-4 col-md-3"> 
            <select class="form-control  " style="width: 100%;border-radius: 40px;" id="idpais" name="idpais" >  
                <option value="{{$alumno->distrito->provincia->departamento->pais->idpais}}" disabled selected>{{$alumno->distrito->provincia->departamento->pais->pais}}</option>
    ...
    <div class="row ">
        ...
        <div class="col-sm-4 col-md-3"> 
            <select class="form-control " style="width: 100%;border-radius: 40px;" id="iddepartamento" name="iddepartamento" disabled>  
                <option value="{{$alumno->distrito->provincia->departamento->iddepartamento}}" disabled selected>{{$alumno->distrito->provincia->departamento->departamento}}</option>
            </select>  
        </div>
        <div class="col-sm-2 col-md-1" > 
        ...
        <div class="col-sm-4 col-md-3"> 
            <select class="form-control " style="width: 100%;border-radius: 40px;" id="idprovincia" name="idprovincia" disabled>  
                <option value="{{$alumno->distrito->provincia->idprovincia}}" disabled selected>{{$alumno->distrito->provincia->provincia}}</option>  
            </select>  
        </div>
        ...
        <div class="col-sm-4 col-md-3"> 
            <select class="form-control " style="width: 100%;border-radius: 40px;" id="iddistrito" name="iddistrito" disabled>  
                < <option value="{{$alumno->distrito->iddistrito}}" disabled selected>{{$alumno->distrito->distrito}}</option>   
            </select>  
        </div>
    ...
    <div class="col-md-12 text-center ">  
            <div class="form-group"> 
                <button class="btn btn-success mr-4" id="btnRegistrar" data-loading text="<i class='fa a-spinner fa-spin'></i> Registrando"> 

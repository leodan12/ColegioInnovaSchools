...
<div class="row" style="text-align: center"><div class="col-12">
  <button  type="submit" value="Grabar" id="Grabar" class="btn btn-success mr-4" onclick="return confirm('Grabar ?')"style="border-radius: 40px;"><i class="fas fa-save"> </i>&nbsp;Grabar</button>

...
<div class="wrap row ">
      ...
      <div class="tarjeta-wrap col-8 col-md-8 col-lg-8 ">
        <div class="tarjeta">
          <div class="adelante" style="background-image:url('/img/FLYER.png');background-size: cover;"></div>
          <h5>⭐BRAÚL PORRAS, RICHARD ROBERT</h5>

          <div class="atras">                  
            <p>       
              <h5>⭐ATAUCURI YNFANTE, ISAAC DANIEL</h5>
              <h5>⭐BRAÚL PORRAS, RICHARD ROBERT</h5>
              <h5>  ⭐ MACHUCA IPARRAGUIRRE, LEODAN </h5>
              <h5>⭐ VALDIVIA RAMOS, ROBERTO JOSE</h5>
              <h5>⭐BRAÚL PORRAS, RICHARD ROBERT</h5>
              <h5>⭐ VILLARROEL RODRIGUEZ, LEANDRO </h5>

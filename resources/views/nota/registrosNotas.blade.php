      ...
      <h3 class="text-center">REGISTROS DE NOTAS</h3>
         ...
         <nav class="navbar navbar-light ">
          ...
          <form class="form-inline my-2 my-lg-0 float-right" method="GET">
            <input name="buscarpor" style="border-radius: 40px;" class="form-control col-8 mr-2" type="search" placeholder="Buscar por grado" aria-label="Search" value="{{$buscarpor}}">

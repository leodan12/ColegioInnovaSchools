...
<div class="container-fluid">
  ...
  @if(session('datos'))  <!--Buscar una alerta en el caso q nuestro registro ha sido guardado o hemos cancelado-->
     ...
     <div class="row" style="text-align: center"><div class="col-12"><h5> OPCIONES PARA TRABAJAR CON LAS NOTAS</h5></div></div>
      ...
      <div class="row" >
        <div class="col-5 d-sm-none" style="position: relative;right: 7%;padding-right: 0px;padding-left: 0px;">
          <button class=" btn btn-success mr-0" style="border-radius: 40px;"   type="menu"><a class="text-white" href="../inicio" ><i class="fas fa-arrow-left"> </i> Regresar</a> </button>
        </div>
        ...
        <div class="col-12 col-sm-3" style="padding-right: 0px;padding-left: 0px;">
          <a type="button" href="{{route('nota.create')}}" class="btn btn-success" style="border-radius: 40px;text-align: left"   ><i class="fas fa-plus"></i>&nbsp;Agregar Nota</a><br>
      
        </div>
        <div class="col-12 col-sm-4" style="padding-right: 0px;padding-left: 0px;">
          
          <a href="{{route('nota.libretas')}}" class="btn btn-success" style="border-radius: 40px;" ><i class="fas fa-graduation-cap"></i>&nbsp;Ver Libretas</a>
        </div>
        <div class="col-12 col-sm-5" style="padding-right: 0px;padding-left: 0px;">
          
          <a href="{{route('nota.registros')}}" class="btn btn-success" style="border-radius: 40px;"><i class="fa fa-book mr-2"></i>Ver Registros de Notas</a>
        </div>
      </div>
      <br><br>
...
<div class="row">
  ...
  <div class="d-none d-sm-block col-3 d-md-none"></div>
  <div class="   col-12 col-sm-6 col-md-3 text-center">

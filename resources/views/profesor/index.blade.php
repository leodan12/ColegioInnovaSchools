...
<nav class="navbar navbar-light ">
    ...
    <form class="form-inline my-2 my-lg-0 float-right" method="GET">  <!--Para que se vaya a la derecha de la pagina float-->
        <input name="buscarpor" class="form-control col-8 mr-2" type="search" placeholder="Buscar por Nombre" aria-label="Search" value="{{ $buscarpor }}" style="border-radius: 40px;"  >

    ...
    <div class="collapse navbar-collapse justify-content-start" filter-color="black" id="navigation"  filter-color="black" >
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Inicio" data-placement="bottom" href="/profesor2">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Registro de Notas" data-placement="bottom" href="../../cursosProfesor">
              <h5>NOTAS</h5>
            </a>
          </li>

          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Registro de Alumnos" data-placement="bottom" href="../../cursosProfesor">
              <h5>CURSOS</h5>
            </a>
          </li>

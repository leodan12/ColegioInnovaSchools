    ...
    <div class="collapse navbar-collapse justify-content-start" filter-color="black" id="navigation"  filter-color="black" >
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Inicio" data-placement="bottom" href="../inicioAlumnos">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Registro de Notas" data-placement="bottom" href="../../cursosAlumno
            </a>
          </li>

          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Registro de Alumnos" data-placement="bottom" href="../../cursosAlumno">
              <h5>CURSOS</h5>
            </a>
          </li>
      ...
      <div class="content-section-heading" >
        ...
        <a class="navbar-brand" href="#" rel="tooltip" title="Hemos trabajado mucho en este proyecto" data-placement="bottom" >    
            <div class="d-md-none h6" >⭐ BIENVENIDO A EL PROYECTO DE SISTEMAS DE INFORMACIÓN⭐</div>
            <div class="d-none d-md-block h5" >⭐ BIENVENIDO A EL PROYECTO DE SISTEMAS DE INFORMACIÓN⭐</div>
        </a>
